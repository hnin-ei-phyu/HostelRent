...
<div class="row">
    ...
    <div class="col-lg-8">
        <form action="{{route('leaserposts.update',$leaserpost->id)}}" style="width: 80%;" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="roomtype" class="form-control mb-3" value="{{$leaserpost->roomtype}}">
            <input type="text" name="room_area" class="form-control mb-3" value="{{$leaserpost->room_area}}">
            <input type="text" name="address" class="form-control mb-3" value="{{$leaserpost->address}}">
            <input type="text" name="price" class="form-control mb-3" value="{{$leaserpost->price}}">
            <input type="text" name="facilities" class="form-control mb-3" value="{{$leaserpost->facilities}}">
            <textarea type="text" name="description" class="form-control mb-3" value="{{$leaserpost->description}}"></textarea>
            <input type="text" name="phone" class="form-control mb-3" value="{{$leaserpost->phone}}">
            ...
            <a href="{{route('leaserposts.index')}}" class="form-control mb-3 btn btn-warning"><i class="fa fa-circle-left"></i> Go Back </a>
        </form>
    </div>
   </div>
